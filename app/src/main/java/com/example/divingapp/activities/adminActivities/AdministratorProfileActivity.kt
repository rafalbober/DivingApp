...
class AdministratorProfileActivity : AppCompatActivity(), IInstructorProfileView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etName = findViewById(R.id.et_admin_profile_name)
        etSurname = findViewById(R.id.et_admin_profile_surname)
        etEmail = findViewById(R.id.et_admin_profile_email)
        etPhone = findViewById(R.id.et_admin_profile_phone)
        btSave = findViewById(R.id.bt_admin_profile_save)
        btReset = findViewById(R.id.bt_admin_profile_reset)
    ...
    override fun onStart() {
        super.onStart()
        profilePresenter.onStart(firebaseUser, database, "Administrators")
    }
    ...
    override fun editUserData(user: User) {
        val reference: DatabaseReference = database.getReference("Administrators").child(firebaseUser.uid)
